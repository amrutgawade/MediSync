...
function Register() {
  ...
  return (
    <main className="w-full flex flex-col items-center justify-center py-4">
      <div className="max-w-sm w-full text-gray-600 mb-4">
        <div className="text-center">
          <div className="mt-5 space-y-2">
            <h3 className="text-gray-800 font-bold text-3xl">Register</h3>
            <p className="">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="mt-8 space-y-5">
          ...
          <div>
            ...
            <select
              onChange={(e) => inputChangeHandler("hospital", e.target.value)}
              value={hospital}
              required
              className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-red-600 shadow-sm rounded-lg"
            >
